            ...
            <ul>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                ...
                                <i data-feather="box"></i><span>Subscription Packages</span><span
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'tags')) subdrop active @endif">
                                <i data-feather="layers"></i><span>Subscription</span><span class="menu-arrow"></span>
                            </a>
                            <ul class="bintel-menu">
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'orders')) subdrop active @endif">
                            ...
                            <ul class="bintel-menu">
                                ...
                                @if (can_view(route('orders.paid')))
                                    <li>
                                        <a class="@if (Route::currentRouteName() == 'orders.paid') subdrop active @endif"
                                            href="{{ route('orders.paid') }}">Paid Sale</a>
                                    </li>
                                @endif


                                @if (can_view(route('orders.unpaid')))
                                    <li>
                                        <a class="@if (Route::currentRouteName() == 'orders.unpaid') subdrop active @endif"
                                            href="{{ route('orders.unpaid') }}">Unpaid Sale</a>
                                    </li>
                                @endif
                                ...
                                @if (can_view(route('orders.index')))
                                    <li>
                                        <a class="@if (Route::currentRouteName() == 'orders.index') subdrop active @endif"
                                            href="{{ route('orders.index') }}">All Sale</a>
                                    </li>
                                @endif
                                @if (can_view(route('subscription-orders.index.ajax')))
                                    <li>
                                        <a class="@if (Route::currentRouteName() == 'subscription-orders.index.ajax') subdrop active @endif"
                                            href="{{ route('subscription-orders.index.ajax') }}">All Subscription Order </a>
                                    </li>
                                @endif
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'pos')) subdrop active @endif">
                        ...
                        {{-- <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'orderstatuses')) subdrop active @endif">
                            ...
                            <ul class="bintel-menu">
                                ...
                                @if (can_view(route('orderstatuses.index')))
                                    <li>
                                        <a  class="@if (Route::currentRouteName() == 'orderstatuses.index') subdrop active @endif" href="{{ route('orderstatuses.index') }}"><i data-feather="box"></i>List</a>
                                    </li>
                                @endif

                                @if (can_view(route('orderstatuses.create')))
                                    <li >
                                        <a class="@if (Route::currentRouteName() == 'orderstatuses.create') subdrop active @endif" href="{{ route('orderstatuses.create') }}"><i
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'couriers')) subdrop active @endif">
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'paymentmethod')) subdrop active @endif">
                                <i data-feather="credit-card"></i><span>Payment Method</span><span
                                    class="menu-arrow"></span>
                            </a>
                            <ul class="bintel-menu">
                    ...
                    <ul>
                        ...
                        @if (can_view(route('homecart1.index')))
                            <li class="@if (Route::currentRouteName() == 'homecart1.index') active @endif">
                                <a href="{{ route('homecart1.index') }}"><i data-feather="monitor"></i><span>Home
                                        Banner</span></a>
                            </li>
                        @endif
                        ...
                        @if (can_view(route('homecart1.index2')))
                            <li class="@if (Route::currentRouteName() == 'homecart1.index2') active @endif">
                                <a href="{{ route('homecart1.index2') }}"><i data-feather="monitor"></i><span>Popup
                                        Banner</span></a>
                            </li>
                        @endif
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'sections')) subdrop active @endif">
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="submenu">
                            ...
                            <a href="javascript:void(0);"
                                class="@if (is_active(Route::currentRouteName(), 'orderstatuses') || is_active(Route::currentRouteName(), 'paymentmethod')) subdrop active @endif">
                        ...
                        @if (can_view(route('review.index')))
                            <li class="@if (Route::currentRouteName() == 'review.index') active @endif">
                                <a href="{{ route('review.index') }}"><i
                                        data-feather="message-square"></i><span>Reviews</span></a>
                            </li>
                        @endif
                    </ul>
                </li>
