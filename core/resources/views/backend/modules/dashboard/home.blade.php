                    ...
                    <div class="card-body">
                        <div class="table-responsive dataview">
                            <table class="table dashboard-recent-products">
                                ...
                                <tbody>
                                    <tr v-for="(product, index) in recentProducts" :key="product.id">
                                        <td>@{{ index + 1 }}</td>
                                        <td class="productimgname">
                                            <a href="#" class="product-img">
                                                <img :src="getImageUrl(product.thumb_image)" alt="product">
                                            </a>
                                            <a href="">@{{ product.bangla_name }}</a>
                                        </td>
                        ...
                        <div class="table-responsive dataview">
                            <table class="table dashboard-recent-products">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(product, index) in lowStockProducts" :key="product.id">
                                        <td>@{{ index + 1 }}</td>
                                        <td class="productimgname">
                                            <a href="#" class="product-img">
                                                <img :src="getImageUrl(product.thumb_image)" alt="product">
                                            </a>
                                            <a class="fs-6 fw-bold" href="#">@{{ product.bangla_name }}</a>
                                        </td>

                                        <td>
                                            <p class="stock-alert">@{{ product.stock }}</p>
                                        </td>
                                    </tr>
