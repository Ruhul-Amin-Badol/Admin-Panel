                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <div class="mb-3 add-product input-group">
                                            <input type="number" step="1" class="form-control" name="duration"
                                                value="{{ $subscriptionPackage->duration }}" placeholder="Enter Duration Days">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <select class="select" name="status">
                                                <option value="1" {{ $subscriptionPackage->status == 1 ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ $subscriptionPackage->status == 0 ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <select class="select" id="discount_type" name="discount_type">
                                                <option value="percent" {{ $subscriptionPackage->discount_type == 'percent' ? 'selected' : '' }}>% (percent)</option>
                                                <option value="amount" {{ $subscriptionPackage->discount_type == 'amount' ? 'selected' : '' }}>Amount</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Discount Amount<span class="star-sign">*</span></label>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Current Price<span class="star-sign">*</span></label>
                                            <input type="number" step="0.01" class="form-control" id="current_price"
                                                name="current_price" value="{{ $subscriptionPackage->current_price }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div id="feature-fields">
                                            @foreach ($subscriptionPackage->features as $feature)
                                                <div class="input-group mb-3">
                                                    ...
                                                    <button type="button" class="btn  remove-feature"><i class="ion-close-round text-danger"></i></button>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            <button type="button" class="btn btn-primary" id="add-more-features"> <i class="ion-plus-round"></i></button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#mrp_price, #discount_type, #discount_amount').on('input change', function() {
                ...
                let currentPrice = discountType === 'percent' ? mrp - (mrp * discountAmount / 100) : mrp - discountAmount;
            ...
            $('#feature-fields').on('click', '.remove-feature', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire('Success!', response.message, 'success').then(() => {
                            window.location.href = '{{ route('subscription-packages.index') }}';
                        });
                    },
                    error: function(xhr) {
